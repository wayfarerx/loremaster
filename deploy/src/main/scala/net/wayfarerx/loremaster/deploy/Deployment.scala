...
trait Deployment:
   ...
   */
  protected final def sqsQueue[T: ClassTag](tags: Tag*): Entries =
   ...
   */
  protected final def sqsToLambdaMapping[T: ClassTag](tags: Tag*): Entries = Entries(
  ...
  protected final def sqsQueueToLambdaFunction[T: ClassTag, F: ClassTag](
    ...
    sqsQueue[T](tags *) ++ lambdaFunction[T](
      description,
      s3Bucket,
      s3Key,
      fullName[F],
